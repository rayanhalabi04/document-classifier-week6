...
class TestReadSecret:
    ...
    def test_reads_secret_value_for_valid_path_and_key(
        self, vault_adapter, mock_hvac_client
    ):
    ...
    def test_raises_vault_secret_not_found_for_missing_path(
        self, vault_adapter, mock_hvac_client
    ):
    ...
    def test_raises_vault_key_not_found_for_missing_key(
        self, vault_adapter, mock_hvac_client
    ):
    ...
    def test_raises_vault_connection_error_on_vault_error(
        self, vault_adapter, mock_hvac_client
    ):
...
class TestValidateRequiredSecrets:
    ...
    def test_returns_all_true_when_all_secrets_present(
        self, vault_adapter, mock_hvac_client
    ):
...
class TestVaultAdapterInit:
    ...
    def test_raises_connection_error_when_client_not_authenticated(
